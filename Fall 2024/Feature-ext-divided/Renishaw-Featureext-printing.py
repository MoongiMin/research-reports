...
# 파일 경로
file_path = r"C:\Users\mmgzz\Desktop\ME Lab Machine Learning\Renishaw Sound\Renishaw Sound\Renishaw1\20241113_183143.015138Z_printing_state_sound0-5min.wav"
...
feature_save_path = os.path.join(save_path, "features_printing.csv")
